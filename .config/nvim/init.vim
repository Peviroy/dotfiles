...
" |.  \    /:  | /   /     
" |___|\__/|___||___/      
"  _____  ___  ___      ___  __     ___      ___   _______    ______   
" (\"   \|"  \|"  \    /"  ||" \   |"  \    /"  | /"      \  /" _  "\  
" |.\\   \    |\   \  //  / ||  |   \   \  //   ||:        |(: ( \___) 
" |: \.   \\  | \\  \/. ./  |:  |   /\\  \/.    ||_____/   ) \/ \      
" |.  \    \. |  \.    //   |.  |  |: \.        | //      /  //  \ _   
" |    \    \ |   \\   /    /\  |\ |.  \    /:  ||:  __   \ (:   _) \  
"  \___|\____\)    \__/    (__\_|_)|___|\__/|___||__|  \___) \_______) 
" =====================================================================
" Forked: @theniceboy
" Author: @peviroy
...
set visualbell
set completeopt=longest,noinsert,menuone,noselect,preview "completion popup menu
set updatetime=300
...
" Better tab
set noexpandtab		"no convert to space
set tabstop=2
set shiftwidth=2
set softtabstop=2
set autoindent
...
" Timeout
set ttimeoutlen=0		"keycode timeout immediately
set notimeout				"mapping never timeout
...
" Change backup and undo file location
...
" Call figlet
noremap tx :r !figlet -k -t merlin1
